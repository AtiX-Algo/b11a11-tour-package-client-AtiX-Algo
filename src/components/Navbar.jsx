        ...
        <div className="navbar bg-base-100 shadow-sm container px-4 mx-auto">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[10] p-2 shadow bg-base-100 rounded-box w-52">
                        {navLinks}
                        {user && loggedInLinks}
                        {user && guideLinks} {/* Assuming any logged in user can be a guide for this assignment */}
                    </ul>
                </div>
                <Link to="/" className="btn btn-ghost text-xl md:text-2xl font-bold">TourTrek</Link>
            </div>
            ...
            <div className="navbar-end">
                <label className="swap swap-rotate mr-2">
                    ...
                    <svg className="swap-off fill-current w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22,8.27,8.27,0,0,1,12.14,1.8A10.1,10.1,0,0,0,12,22,10.2,10.2,0,0,0,22,12.14a8.38,8.38,0,0,1-3.37.73A8.15,8.15,0,0,1,12.14,19.69Z"/></svg>
                </label>
                        ...
                        <div className="dropdown dropdown-end z-[10]">
                            <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                                <div className="w-10 rounded-full">
                                    <img alt="User Profile" src={user?.photoURL || 'https://i.ibb.co/6n21hgy/user-thumb.jpg'} />
                                </div>
                            </div>
