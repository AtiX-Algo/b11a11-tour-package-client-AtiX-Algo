      ...
      <div className="navbar-start">
        <div className="dropdown">
          ...
          >
            {navLinks}
            {user && loggedInLinks}
            {/* Show guide links only when role === 'guide' */}
            {user && !roleLoading && role === "guide" && guideLinks}
          </ul>
        </div>
